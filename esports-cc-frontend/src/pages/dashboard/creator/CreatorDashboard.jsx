...
import ProjectStats from "../../../components/creator/ProjectStats";
...
export default function CreatorDashboard() {
  ...
  if (!user || (user.role !== 0 && user.role !== "CREATOR")) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50">
        <div className="text-center bg-white/80 backdrop-blur-md rounded-2xl p-8 shadow-xl">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-8 pt-24">
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-gray-600 text-lg">
                Manage your projects and hire new freelancers
              </p>
            </div>
        ...
        {/* Project Stats */}
        <ProjectStats dashboardData={dashboardData} />
        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <HiPlay className="w-6 h-6 text-orange-600" />
            </div>
            <p className="text-3xl font-bold text-gray-900">
            ...
            {dashboardData.projects.filter(
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <motion.button
                        ...
                        className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-lg font-medium transition-all text-sm min-w-fit hover:shadow-lg"
                      >
                        Open
                      </motion.button>
                    </div>
              ...
              <div className="bg-white/80 backdrop-blur-md p-8 rounded-2xl shadow-lg text-center border border-gray-200">
                ...
                <p className="text-sm text-gray-400 mb-6">
                  Start by browsing the marketplace to hire freelancers
                </p>
                <motion.button
                  whileHover={{ scale: 1.05, y: -2 }}
                  whileTap={{ scale: 0.95 }}
