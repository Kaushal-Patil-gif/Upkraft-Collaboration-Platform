...
export default function ModernNavbar() {
  ...
  const getProfilePath = () => {
    ...
    if (user.role === 0 || user.role === "CREATOR") return "/profile/creator";
                ...
                <div className="relative profile-dropdown">
                  ...
                  <AnimatePresence>
                    {isProfileOpen && (
                      ...
                      >
                        <Link to={getProfilePath()} className="block px-4 py-2 text-gray-700 hover:bg-gray-50">Profile</Link>
                        <Link to={getDashboardPath()} className="block px-4 py-2 text-gray-700 hover:bg-gray-50">Dashboard</Link>
                        <hr className="my-2" />
                        <button 
